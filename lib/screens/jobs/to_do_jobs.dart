            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  Padding(
                    padding: EdgeInsetsDirectional.fromSTEB(Dimensions.height20, 0, 0, 0),
                    child: HeadingText(text: "To Do",color: Colors.white,size: Dimensions.height20/1.15,fontWeight: FontWeight.bold,),
                  ),],
              ),
              SizedBox(height: Dimensions.height5,),
              Row(
              ...
              },style: whiteButton, child: HeadingText(text: "Move to In-Progress",size: Dimensions.font16,color: AppColors.mainColor,fontWeight: FontWeight.bold),)
